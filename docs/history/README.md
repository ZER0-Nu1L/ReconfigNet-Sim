...
| [HTTP/gRPC 性能对比](./ocs-http-grpc-performance.md) | P4App 分层时延、dedicated-thread 根因分析和历史数值 |
| [HTTP 到 gRPC 迁移指南](./ocs-http-to-grpc-migration-guide.md) | 旧候选架构阶段的 wire API 迁移方法 |
